...
year. It returns the top five percent of all members in that cohort (2008-2010)
along with their diagnosis and procedure codes.
...
/*
fifth cte creates a table with diagnosis and procedure codes to join
...
WHERE rm.utilizer_rank <= rm.top_5pct_cutoff
